...
class SecurityAssessmentRegistryTest {
    ...
    @Test
    fun unknown_profile_falls_back_without_throwing() =
        runTest {
            val profile =
                com.wifiauditlab.assessment.domain.wifi.WifiSecurityProfile(
