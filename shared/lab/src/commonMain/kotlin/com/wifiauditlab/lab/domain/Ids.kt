...
value class SearchStrategyId(val value: String) {
    init { require(value.isNotBlank()) { "SearchStrategyId must not be blank" } }
...
value class SearchSessionId(val value: String) {
    init { require(value.isNotBlank()) { "SearchSessionId must not be blank" } }
    override fun toString(): String = value
...
value class ChallengeId(val value: String) {
    init { require(value.isNotBlank()) { "ChallengeId must not be blank" } }
    override fun toString(): String = value
